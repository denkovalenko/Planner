...
var colModel = [
    ...
    { name: 'PlannedPract', index: 'PlannedPract', resizable: false , width: 40, formatter: 'integer', sorttype: 'integer', align: 'right', editable: true, formoptions: { label: 'Проведення практичних занять (пл.)' }, editrules: editruleInteger },
    { name: 'DonePract', index: 'DonePract', resizable: false , width: 40, formatter: 'integer', sorttype: 'integer', align: 'right', editable: true, formoptions: { label: 'Проведення практичних занять (вик.)' }, editrules: editruleInteger },
    ...
    { name: 'PlannedCheckControl', index: 'PlannedCheckControl', resizable: false , width: 40, formatter: 'integer', sorttype: 'integer', align: 'right', editable: true, formoptions: { label: 'Проведення контрольних робіт, що виконують під час аудиторних занять (пл.)' }, editrules: editruleInteger },
    { name: 'DoneCheckControl', index: 'DoneCheckControl', resizable: false , width: 40, formatter: 'integer', sorttype: 'integer', align: 'right', editable: true, formoptions: { label: 'Проведення контрольних робіт, що виконують під час аудиторних занять (вик.)' }, editrules: editruleInteger },
