...
var colModel = [
    ...
    { name: 'PlannedTotal', index: 'PlannedTotal', width: 20,  sorttype: 'integer', align: 'right', formoptions: { label: 'Усього (пл.)' }, editrules: editruleInteger, formatter: function (cellvalue, options, rowObject) {
    ...
    {
        name: 'DoneTotal', index: 'DoneTotal', width: 20, sorttype: 'integer', align: 'right', formoptions: { label: 'Усього (вик.)' }, editrules: editruleInteger, formatter: function (cellvalue, options, rowObject) {
