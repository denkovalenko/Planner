...
namespace Planner.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Code,FacultyId")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Code,FacultyId")] Department department)
        {
            if (ModelState.IsValid)
            {
